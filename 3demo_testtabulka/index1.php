    ...
    <div class="project_table">
        ...
        <table id="mySearchTable" class="search_project_table">
            ...
            if ( count($search_columns) == 1 ) {
              $sql = "SELECT id, web_nazev, kategorie, plny_nazev, plny_popis, cilova_skupina, souvisejici_kategorie, vyuzitelne_produkty FROM typova_reseni WHERE " . $search_columns[0] . " > 0 ORDER BY " . $search_columns[0] . " ASC";
              ...
              $sql = $sql . "ORDER BY searchTotal ASC";
