  ...
  <body class="is-preload">
    ...
    <div id="wrapper">
      ...
      <div id="main">
        ...
        <article id="ocirkularni">
          <h2 class="major">O Cirkulární ekonomice</h2>
          ...
          <p>
            ...
            <strong>aktuálního, lineárního způsobu hospodaření</strong>. CE
          ...
          <p>
            Projekt vznikl na základě <strong>definovaných potřeb obcí</strong>,
          ...
          <p>
            ...
            <strong>cíl definovat a ověřit kroky k přechodu obcí na CE</strong>,
		  ...
		  <a href="info.php" class="button primary small">Chci více informací o tématu</a>
        </article>
        ...
        <article id="jsemStarostaDalsi">
		  ...
		  <p> 
			<a href="#vyberTemata" class="button primary small"> Vyberte téma 
        ...
        <article id="principyvyroby">
          <h2 class="major">
            Principy Cirkulární ekonomiky<br />
            ve výrobě
          </h2>
		  <span class="image main"><img src="images/pic03.jpg" alt=""/></span>
		  <a href="http://obcevkruhu.cz/0demo/register.php" class="button primary small">Přihlásit se</a><p></p>
